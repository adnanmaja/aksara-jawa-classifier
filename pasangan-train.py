...
traindir = "D:/Python/Aksara/pasangan_splits/train" 
valdir = "D:/Python/Aksara/pasangan_splits/val"     
testdir = "D:/Python/Aksara/pasangan_splits/test"  
...
print(f"Test Accuracy: {accuracy:.2f}%") # 100% accuracy (idk how)

# Saving the model
torch.save(model.state_dict(), "pasangan_model.pth")
print("Model saved")